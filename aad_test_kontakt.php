	...
	<div class="price_table">
			...
			<div class="three_price_blocks">
				...
				<?php if(get_post_meta($post_id,'featured_table',true)=='1') { ?>
					<div class="popl_price">
						<p><?php echo get_post_meta($post_id,'pricing_featured_1_title',true); ?></p>
					</div>
				<?php } ?>
				<?php if(get_post_meta($post_id,'featured_table',true)=='1') { ?>
					<div class="innter_cent_pack">
				<?php } ?>
					<h6><?php echo get_post_meta($post_id,'pricing_1_title',true); ?></h6>
				<?php if(get_post_meta($post_id,'featured_table',true)=='1') { ?>
					<div class="pop_price">
						<p><?php echo get_post_meta($post_id,'pricing_1_price',true); ?></p>
						<span><?php echo get_post_meta($post_id,'pricing_featured_1_text',true); ?></span>
					</div>
				<?php } else  { ?>
					<p class="weight_price"><?php echo get_post_meta($post_id,'pricing_1_price',true); ?></p>
				<?php } ?>
					<div class="text_ofel">
						<p><?php echo get_post_meta($post_id,'pricing_1_text',true); ?></p>
					</div>
					<div class="choose_packet   <?php if(get_post_meta($post_id,'featured_table',true)=='1') { echo "active_packet"; } else { echo ""; } ?> ">
						<a href="<?php echo get_post_meta($post_id,'pricing_1_button_url',true); ?>" data-id="Vælg plan"><?php echo get_post_meta($post_id,'pricing_1_button',true); ?></a>
					</div>
				<?php if(get_post_meta($post_id,'featured_table',true)=='1') { ?>
					</div>
				<?php } ?>
				...
				<?php if(get_post_meta($post_id,'featured_table',true)=='2') { ?>
					<div class="popl_price">
						<p><?php echo get_post_meta($post_id,'pricing_featured_2_title',true); ?></p>
					</div>
				<?php } ?>
				<?php if(get_post_meta($post_id,'featured_table',true)=='2') { ?>
					<div class="innter_cent_pack">
				...
				<?php if(get_post_meta($post_id,'featured_table',true)=='2') { ?>
					<div class="pop_price">
						...
						<span><?php echo get_post_meta($post_id,'pricing_featured_2_text',true); ?></span>
					</div>
				<?php } else  { ?>
					<p class="weight_price"><?php echo get_post_meta($post_id,'pricing_2_price',true); ?></p>
				<?php } ?>
					<div class="text_ofel">
						<p><?php echo get_post_meta($post_id,'pricing_2_text',true); ?></p>
					</div>
					<div class="choose_packet  <?php if(get_post_meta($post_id,'featured_table',true)=='2') { echo "active_packet"; } else { echo ""; } ?> ">
						<a href="<?php echo get_post_meta($post_id,'pricing_2_button_url',true); ?>" data-id="Vælg pakke"><?php echo get_post_meta($post_id,'pricing_2_button',true); ?></a>
					</div>
				<?php if(get_post_meta($post_id,'featured_table',true)=='2') { ?>
					</div>
				<?php } ?>
		...
		<div class="elem_of_p <?php if(get_post_meta($post_id,'featured_table',true)=='3') { echo "center_elpr"; } else { echo "control_pos"; } ?>">
				...
				<?php if(get_post_meta($post_id,'featured_table',true)=='3') { ?>
					<div class="innter_cent_pack">
				<?php } ?>
					<h6><?php echo get_post_meta($post_id,'pricing_3_title',true); ?></h6>
				<?php if(get_post_meta($post_id,'featured_table',true)=='3') { ?>
					<div class="pop_price">
						<p><?php echo get_post_meta($post_id,'pricing_3_price',true); ?></p>
						<span><?php echo get_post_meta($post_id,'pricing_featured_3_text',true); ?></span>
					</div>
				<?php } else  { ?>
					<p class="weight_price"><?php echo get_post_meta($post_id,'pricing_3_price',true); ?></p>
				<?php } ?>
					<div class="text_ofel">
						<p><?php echo get_post_meta($post_id,'pricing_3_text',true); ?></p>
					</div>
					<div class="choose_packet   <?php if(get_post_meta($post_id,'featured_table',true)=='3') { echo "active_packet"; } else { echo ""; } ?> ">
						<a href="<?php echo get_post_meta($post_id,'pricing_3_button_url',true); ?>" data-id="Vælg plan"><?php echo get_post_meta($post_id,'pricing_3_button',true); ?></a>
					</div>
				<?php if(get_post_meta($post_id,'featured_table',true)=='3') { ?>
					</div>
				<?php } ?>
